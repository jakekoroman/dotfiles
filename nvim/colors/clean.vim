...
if &background ==# 'dark'
  ...
  hi Normal guifg=#e4e4ef guibg=#181818 gui=NONE cterm=NONE
  ...
  hi LineNr guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  ...
  hi Pmenu guifg=#e4e4ef guibg=#101010 gui=NONE cterm=NONE
  hi PmenuSbar guifg=#e4e4ef guibg=#101010 gui=NONE cterm=NONE
  hi PmenuSel guifg=#ad7fa8 guibg=#101010 gui=NONE cterm=NONE
  ...
  hi StatusLineNC guifg=#e4e4ef guibg=#181818 gui=reverse cterm=reverse
  ...
  hi Visual guifg=#ffaf00 guibg=#181818 gui=reverse cterm=reverse
  ...
  hi Special guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi Statement guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi Todo guifg=#181818 guibg=#ffffff gui=bold,reverse cterm=bold,reverse
  hi Type guifg=#3465a4 guibg=NONE gui=NONE cterm=NONE
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#181818', '#af0000', '#005f00', '#af5f00', '#005faf', '#870087', '#008787', '#d7d7d7', '#626262', '#d70000', '#008700', '#d78700', '#0087d7', '#af00af', '#00afaf', '#ffffff']
  endif
  hi Normal guifg=#e4e4ef guibg=#181818 gui=NONE cterm=NONE
  hi ColorColumn guifg=NONE guibg=#181818 gui=NONE cterm=NONE
  hi Conceal guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  ...
  hi Directory guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi EndOfBuffer guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi ErrorMsg guifg=#e4e4ef guibg=#181818 gui=reverse cterm=reverse
  hi FoldColumn guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#e4e4ef guibg=#181818 gui=NONE cterm=NONE
  hi IncSearch guifg=#e4e4ef guibg=#181818 gui=reverse cterm=reverse
  hi LineNr guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi MatchParen guifg=#e4e4ef guibg=#181818 gui=bold cterm=bold
  hi ModeMsg guifg=#e4e4ef guibg=NONE gui=bold cterm=bold
  hi MoreMsg guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi NonText guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi Pmenu guifg=#e4e4ef guibg=#181818 gui=NONE cterm=NONE
  hi PmenuSbar guifg=#e4e4ef guibg=#181818 gui=NONE cterm=NONE
  hi PmenuSel guifg=#e4e4ef guibg=#181818 gui=NONE cterm=NONE
  hi PmenuThumb guifg=#e4e4ef guibg=#181818 gui=NONE cterm=NONE
  hi Question guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi QuickFixLine guifg=#e4e4ef guibg=#181818 gui=reverse cterm=reverse
  hi Search guifg=#e4e4ef guibg=#181818 gui=reverse cterm=reverse
  hi SignColumn guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi SpecialKey guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi SpellBad guifg=#e4e4ef guibg=#181818 guisp=#af0000 gui=undercurl cterm=underline
  hi SpellCap guifg=#e4e4ef guibg=#181818 guisp=#005faf gui=undercurl cterm=underline
  hi SpellLocal guifg=#e4e4ef guibg=#181818 guisp=#870087 gui=undercurl cterm=underline
  hi SpellRare guifg=#e4e4ef guibg=#181818 guisp=#008787 gui=undercurl cterm=underline
  hi StatusLine guifg=#e4e4ef guibg=#181818 gui=bold cterm=bold
  hi StatusLineNC guifg=#e4e4ef guibg=#181818 gui=NONE cterm=NONE
  hi TabLine guifg=#e4e4ef guibg=#181818 gui=NONE cterm=NONE
  hi TabLineFill guifg=#e4e4ef guibg=#181818 gui=NONE cterm=NONE
  hi TabLineSel guifg=#e4e4ef guibg=#181818 gui=bold cterm=bold
  hi Title guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi VertSplit guifg=#e4e4ef guibg=#181818 gui=NONE cterm=NONE
  hi Visual guifg=#e4e4ef guibg=#181818 gui=reverse cterm=reverse
  hi VisualNOS guifg=NONE guibg=#181818 gui=NONE cterm=NONE
  hi WarningMsg guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#e4e4ef guibg=#181818 gui=bold cterm=bold
  hi Comment guifg=#e4e4ef guibg=NONE gui=bold cterm=bold
  hi Constant guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi Error guifg=#e4e4ef guibg=#181818 gui=bold,reverse cterm=bold,reverse
  hi Identifier guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi Ignore guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi PreProc guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi Special guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi Statement guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi Todo guifg=#e4e4ef guibg=#181818 gui=bold,reverse cterm=bold,reverse
  hi Type guifg=#e4e4ef guibg=NONE gui=NONE cterm=NONE
  hi Underlined guifg=#e4e4ef guibg=NONE gui=underline cterm=underline
  hi CursorIM guifg=#e4e4ef guibg=#181818 gui=NONE cterm=NONE
  hi ToolbarLine guifg=NONE guibg=#181818 gui=NONE cterm=NONE
  hi ToolbarButton guifg=#e4e4ef guibg=#181818 gui=bold cterm=bold

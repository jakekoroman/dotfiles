...
dmenu_cmd = "dmenu_run -F -i -c -l 16 -p 'Run:' -nb '#222222' -sb '#535d6c'"
...
root.buttons(gears.table.join(
    ...
    -- Scroll wheel support for changing views
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "j",     function () awful.client.incwfact(0.1)          end,
              { description = "increase client height factor"}),
    awful.key({ modkey, "Control" }, "k",     function () awful.client.incwfact(-0.1)         end,
    ...
    awful.key({ modkey, "Control" }, "n",
      ...
      awful.key({}, "XF86AudioLowerVolume", function ()
          awful.util.spawn("amixer -q set Master 2%-", false) end),
    ...
    -- Prompt
    -- NOTE(jake): awful.screen.focused().index-1 because dmenu and awesome have different ways of identifing monitors
    awful.key({ modkey },            "r",     function () awful.spawn(dmenu_cmd.." -m "..awful.screen.focused().index-1) end,
...
awful.rules.rules = {
    ...
    -- Makes emacs not do its own thing
    { rule = { class = "Emacs" },
    properties = { size_hints_honor = false } },
    
    -- Opens Discord left monitor on the 5th tag
    { rule = { class = "discord" },
